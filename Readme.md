...
- [ ] ML models (with scripts) for conflict resolution, sentiment analysis, identity verification.
  ...
  | Implement sentiment analysis ML model         |
  | Integrate identity verification ML algorithms |
...
- [ ] Front End (Policy Thread for voting and feedback & Issue Thread for Complaints) (Conflict Resolution Page)
  ...
  | Create Issue Thread for Complaints          |
  | Develop Conflict Resolution Page           |

- [ ] WEB3 (DID, Social Media, no cost Voting, create-to-earn model)
  | Subtasks                               |
  |----------------------------------------|
  | Implement Decentralized ID (DID)       |
  | Integrate Social Media functionalities|
  | Develop no-cost Voting mechanism      |
  | Design create-to-earn model           |
...
- [ ] Collect stars from all the accounts
  | Subtasks                                      |
  |-----------------------------------------------|
  | Ensure visibility of project on platforms     |
  | Encourage community engagement and feedback  |

- [ ] Update Profile Photo
  | Subtasks                   |
  |----------------------------|
  | Select/update profile photo|
  | Upload to relevant platforms|
